          ...
          <div className="max-w-5xl mx-auto">
            ...
            {projects.length === 0 ? (
              <div className="bg-white border border-black rounded-xl p-16 text-center">
                ...
                <p className="text-sm font-medium text-black mb-6">Create your first project to get started</p>
                <button
                  onClick={() => setShowProjectModal(true)}
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs font-medium text-black">Created {new Date(project.created_at).toLocaleDateString()}</p>
                      </div>
                    </div>
